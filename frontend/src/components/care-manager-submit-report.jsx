      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <InputField
            ...
            onChange={(e) =>
              handleInputChange("physicalHealth", e.target.value)
            }
          ...
          <InputField
            ...
            onChange={(e) =>
              handleInputChange("medicationAdherence", e.target.value)
            }
            options={[
              "Fully Adherent",
              "Mostly Adherent",
          ...
          <InputField
            ...
            onChange={(e) =>
              handleInputChange("exerciseAdherence", e.target.value)
            }
            options={[
              "Fully Adherent",
              "Mostly Adherent",
        ...
        <InputField
          ...
          onChange={(e) =>
            handleInputChange("socialEngagement", e.target.value)
          }
        />
        <InputField
        ...
        {reportData.followUpNeeded === "Yes" && (
          <InputField
            ...
            onChange={(e) =>
              handleInputChange("followUpDetails", e.target.value)
            }
          />
        )}
        <InputField
